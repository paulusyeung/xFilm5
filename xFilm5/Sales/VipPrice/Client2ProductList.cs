...
{
    public partial class Client2ProductList : Form
    {
        ...
        public Client2ProductList()
        {
            InitializeComponent();
        }

        private void Client2ProductList_Load(object sender, EventArgs e)
        {
            SetCaptions();
            SetAttribute();
            SetTheme();
        ...
        private void SetCaptions()
        {
            ...
            colItemCode.Text = oDict.GetWord("client_name");
        ...
        private void SetAttribute()
        {
            ...
            toolTip1.SetToolTip(lvwProductList, "Double click to open Item record");
        }
        ...
        private void ansToolbar_ButtonClick(object sender, ToolBarButtonClickEventArgs e)
        {
            if (!string.IsNullOrEmpty(e.Button.Name))
            {
                ...
                {
                    case "addnew":
                        Client2ProductRecord c2pRecAddNew = new Client2ProductRecord();
                        c2pRecAddNew.EditMode = Common.Enums.EditMode.Add;
                        c2pRecAddNew.ClientId = _ClientId;
                        c2pRecAddNew.ShowDialog();
                        break;
                    case "popup":
                        ShowRecord();
                        break;
        ...
        private void BindVipPriceList()
        {
            ...
            while (reader.Read())
            {
                ListViewItem objItem = this.lvwProductList.Items.Add(reader.GetString(1));  // Client Name
                #region Icon
...
", _ClientId.ToString());
        ...
        private void ShowRecord()
        {
            ...
            {
                int itemId = Convert.ToInt32(lvwProductList.SelectedItem.SubItems[colPricingId.Index].Text);

                Client2ProductRecord c2pRecEdit = new Client2ProductRecord();
                c2pRecEdit.EditMode = Common.Enums.EditMode.Edit;
                c2pRecEdit.PricingId = itemId;
                c2pRecEdit.ShowDialog();
            }
        }
