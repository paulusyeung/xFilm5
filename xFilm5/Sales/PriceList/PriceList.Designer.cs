namespace xFilm5.Sales.PriceList
{
    partial class PriceList
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.colItemName = new Gizmox.WebGUI.Forms.ColumnHeader();
            this.colUnitPrice = new Gizmox.WebGUI.Forms.ColumnHeader();
            this.colUnit = new Gizmox.WebGUI.Forms.ColumnHeader();
            this.colItmeId = new Gizmox.WebGUI.Forms.ColumnHeader();
            ...
            // colItemName
            // 
            this.colItemName.ContentAlign = Gizmox.WebGUI.Forms.ExtendedHorizontalAlignment.Center;
            this.colItemName.Image = null;
            this.colItemName.Text = "Item Name";
            this.colItemName.Width = 400;
            // 
            // colUnitPrice
            // 
            this.colUnitPrice.ContentAlign = Gizmox.WebGUI.Forms.ExtendedHorizontalAlignment.Center;
            this.colUnitPrice.Image = null;
            ...
            // colItmeId
            // 
            this.colItmeId.ContentAlign = Gizmox.WebGUI.Forms.ExtendedHorizontalAlignment.Center;
            this.colItmeId.Image = null;
            this.colItmeId.Text = "Item ID";
            this.colItmeId.Visible = false;
            this.colItmeId.Width = 100;
            // 
            // pnlShortcut
            // 
        ...
        private Gizmox.WebGUI.Forms.ColumnHeader colItemName;
        private Gizmox.WebGUI.Forms.ColumnHeader colUnitPrice;
        private Gizmox.WebGUI.Forms.ColumnHeader colUnit;
        private Gizmox.WebGUI.Forms.ColumnHeader colItmeId;
