...
{
    public partial class PriceListAts : UserControl
    {
        public PriceListAts()
        {
            InitializeComponent();
        ...
        private void SetPriceListAts()
        {
            ...
            ddlNew.MenuItems.Add(new MenuItem(oDict.GetWord("product"), string.Empty, "Item"));
...
//            this.atsClient.Buttons.Add(sep);
        ...
        void cmdMenuClick(object sender, MenuItemEventArgs e)
        {
            if (!(e.MenuItem.Tag == null))
            {
                ...
                {
                    case "item":
                        PriceListRecord client = new PriceListRecord();
