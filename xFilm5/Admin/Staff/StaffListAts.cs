...
{
    public partial class StaffListAts : UserControl
    {
        public StaffListAts()
        {
            InitializeComponent();
        ...
        private void SetPriceListAts()
        {
            ...
            this.atsStaff.MenuHandle = false;
            this.atsStaff.DragHandle = false;
            this.atsStaff.TextAlign = ToolBarTextAlign.Right;
            ...
            this.atsStaff.Buttons.Add(cmdNew);
            ...
            if (!(e.MenuItem.Tag == null))
            {
                switch (e.MenuItem.Tag.ToString().ToLower())
                {
                    case "staff":
                        ...
                        staff.EditMode = Common.Enums.EditMode.Add;
                        staff.ShowDialog();
                        break;
                }
            }
