...
{
    public partial class INV_80mm : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void Invoice_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            this.txtInvoiceDate.DataBindings.Add("Text", DataSource, "InvoiceDate", "{0:yyyy-MM-dd HH:mm:ss}");
