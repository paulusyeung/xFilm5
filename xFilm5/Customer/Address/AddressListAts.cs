...
{
    public partial class AddressListAts : UserControl
    {
        public AddressListAts()
        {
            InitializeComponent();
        ...
        private void SetPriceListAts()
        {
            ...
            ddlNew.MenuItems.Add(new MenuItem("Address", string.Empty, "Address"));
...
//            this.atsClient.Buttons.Add(sep);
        ...
        void cmdMenuClick(object sender, MenuItemEventArgs e)
        {
            if (!(e.MenuItem.Tag == null))
            {
                ...
                {
                    case "address":
                        AddressRecord client = new AddressRecord();
