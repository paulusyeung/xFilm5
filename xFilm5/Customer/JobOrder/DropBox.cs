...
{
    public partial class DropBox : UserControl, IGatewayComponent
    {
        ...
        private void SetFileExplorerAns()
        {
            ...
            this.ansFileExplorer.Buttons[10].Image = new IconResourceHandle("16x16.dropbox_in_16x16.png");

            this.ansFileExplorer.Buttons.Add(new ToolBarButton("RetrieveFile", oDict.GetWord("download_file")));
            this.ansFileExplorer.Buttons[11].Image = new IconResourceHandle("16x16.downloads.png");

            this.ansFileExplorer.Buttons.Add(new ToolBarButton("DeleteFile", oDict.GetWord("delete_file")));
            this.ansFileExplorer.Buttons[12].Image = new IconResourceHandle("16x16.16_L_remove.gif");
