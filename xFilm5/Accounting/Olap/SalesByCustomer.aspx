<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesByCustomer.aspx.cs" Inherits="xFilm5.Accounting.Olap.SalesByCustomer" %>
...
<body style="margin: 0">
    ...
    <div style="font: 9pt Tahoma; border-right: 0; border-top: 0; border-left: 0; padding: 0px 0px 0px 0px;" runat="server" id="divPivotGrid">
        ...
        <asp:SqlDataSource ID="olapSQLSource" runat="server" 
            ...
            SelectCommand="SELECT [Workshop], [ClientName], [Year], [Month], [Day], CONVERT(NVARCHAR(10), [InvoiceDate], 120) AS InvoiceDate, [InvoiceNumber], [InvoiceAmount], [OrderNumber] FROM [vwOlapSalesByCustomer] WHERE ([Year] &gt;= @Year) ORDER BY [Workshop], [ClientName], [InvoiceNumber]">
            <SelectParameters>
