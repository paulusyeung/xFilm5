...
{
    public partial class ReceivablesOlap : UserControl
    {
        public ReceivablesOlap()
        {
            InitializeComponent();
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            String aspx = Path.Combine(Gizmox.WebGUI.Hosting.HostContext.Current.Request.ApplicationPath, "Accounting/Olap/ReceivablesOlapPage.apsx");
            this.olapBox.Path = @"Accounting\Olap\ReceivablesOlapPage.aspx";
