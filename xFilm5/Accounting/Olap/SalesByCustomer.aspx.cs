...
namespace xFilm5.Accounting.Olap
{
    ...
    /// 
    /// </summary>
    public partial class SalesByCustomer : System.Web.UI.Page
    {
        /// <summary>
        ...
        private void BindData()
        {
            ...
            // Client Name
            PivotGridField clientName = new PivotGridField("ClientName", DevExpress.XtraPivotGrid.PivotArea.RowArea);
            clientName.Caption = "Client";
            clientName.AreaIndex = 1;

            if (!olapPivotGrid.Fields.Contains(clientName))
            {
                olapPivotGrid.Fields.AddField(clientName);
            }
            #endregion

            #region Data Area
            // Invoice Amount
            PivotGridField invoiceAmt = new PivotGridField("InvoiceAmount", DevExpress.XtraPivotGrid.PivotArea.DataArea);
            invoiceAmt.Caption = "Invoice Amt.";
