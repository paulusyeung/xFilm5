<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesByProduct.aspx.cs" Inherits="xFilm5.Accounting.Olap.SalesByProduct" %>
...
<body style="margin: 0">
    ...
    <div style="font: 9pt Tahoma; border-right: 0; border-top: 0; border-left: 0; padding: 0px 0px 0px 0px;" runat="server" id="divPivotGrid">
        ...
        <dx:ASPxPivotGridExporter ID="olapPivotGridExporter" runat="server" 
            ASPxPivotGridID="olapPivotGrid" />
        ...
        <asp:SqlDataSource ID="olapSQLSource" runat="server" 
            ...
            SelectCommand="SELECT [Workshop], [Product], [Year], [Month], [Day], CONVERT(NVARCHAR(10), [InvoiceDate], 120) AS InvoiceDate, [InvoiceNumber], [OrderNumber], [Qty], [Amount] FROM [vwOlapSalesByProduct] WHERE ([Year] &gt;= @Year) ORDER BY [Workshop], [Product], [InvoiceDate]">
            <SelectParameters>
                <asp:Parameter DefaultValue="2007" Name="Year" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
    </div>
    </form>
