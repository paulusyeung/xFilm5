...
{
    public partial class SalesByCustomerOlap : UserControl
    {
        public SalesByCustomerOlap()
        {
            InitializeComponent();
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            String aspx = Path.Combine(Gizmox.WebGUI.Hosting.HostContext.Current.Request.ApplicationPath, "Accounting/Olap/SalesByCustomerOlapPage.apsx");
            this.olapBox.Path = @"Accounting\Olap\SalesByCustomerOlapPage.aspx";
