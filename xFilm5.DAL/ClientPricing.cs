...
namespace xFilm5.DAL
{
    ...
    /// Date Created:   2016-11-13 09:13:03
    ...
    public class ClientPricing
    {
        ...
        /// </summary>
        public ClientPricing(int pricingId, int clientId, int itemId, string alias, string tag, decimal unitPrice, int status, DateTime createdOn, int createdBy, DateTime modifiedOn, int modifiedBy, bool retired, DateTime retiredOn, int retiredBy)
        {
