...
{
    public partial class InvoiceSplitted : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public InvoiceSplitted()
        {
            InitializeComponent();
        }

        private void InvoiceSplitted_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            //GroupFooter1.Visible = false;
            //this.Watermark.Text = "RE-PRINT";
            //this.Watermark.ShowBehind = true;

            #region insert Grouping
            var calcFld = new CalculatedField();
            calcFld.Name = "";
            var gf = new GroupField("InvoiceNumber");
            gh1.GroupFields.Add(gf);
            #endregion
        ...
        {
            DateTime receiptDate = (System.DateTime)GetCurrentColumnValue("ReceiptDate");
            txtDate.Text = receiptDate.Year == 1900 ? "" : receiptDate.ToString("yyyy-MM-dd");
            ...
            using (var ctx = new EF6.xFilmEntities())
            {
                ...
                {   // x3 Invoice
                    int invId = (int)GetCurrentColumnValue("INMasterId");
